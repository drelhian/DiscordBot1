        ...
        collector.on('collect', async (i) => {
            ...
            switch (i.values[0]) {
                ...
                case 'moderacion':
                    ...
                    break;
                case 'configuracion':
                    categoryEmbed.setTitle('⚙️ Comandos de configuracion')
                        .setDescription('`set-welcome`, `set-goodbye`, `set-invites`, `set-prefix`, `ticket-setup`, `ticket-add`');
                    break;
                case 'principal':
                ...
                case 'utilidad':
                    categoryEmbed.setTitle('⚙️ Comandos de Utilidad')
                        .setDescription('`avatar`, `userinfo`, `serverinfo`, `perfil`, `remindme`');
                    break;
            }
